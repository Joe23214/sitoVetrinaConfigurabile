...
var modeNasal$2 = { exports: {} };
var hasRequiredModeNasal;
function requireModeNasal() {
  if (hasRequiredModeNasal) return modeNasal$2.exports;
  hasRequiredModeNasal = 1;
  (function(module, exports) {
    ace.define("ace/mode/nasal_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.NasalHighlightRules = NasalHighlightRules;
    });
    ...
    ace.define("ace/mode/nasal", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/nasal_highlight_rules", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var NasalHighlightRules = require2("./nasal_highlight_rules").NasalHighlightRules;
  ...
  return modeNasal$2.exports;
}
var modeNasalExports = requireModeNasal();
const modeNasal = /* @__PURE__ */ getDefaultExportFromCjs(modeNasalExports);
const modeNasal$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeNasal
}, [modeNasalExports]);
export {
