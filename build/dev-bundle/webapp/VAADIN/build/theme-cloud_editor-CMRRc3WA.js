...
var themeCloud_editor$2 = { exports: {} };
var hasRequiredThemeCloud_editor;
function requireThemeCloud_editor() {
  if (hasRequiredThemeCloud_editor) return themeCloud_editor$2.exports;
  hasRequiredThemeCloud_editor = 1;
  (function(module, exports) {
    ace.define("ace/theme/cloud_editor-css", ["require", "exports", "module"], function(require2, exports2, module2) {
    ...
    ace.define("ace/theme/cloud_editor", ["require", "exports", "module", "ace/theme/cloud_editor-css", "ace/lib/dom"], function(require2, exports2, module2) {
      exports2.isDark = false;
      exports2.cssClass = "ace-cloud_editor";
      exports2.cssText = require2("./cloud_editor-css");
  ...
  return themeCloud_editor$2.exports;
}
var themeCloud_editorExports = requireThemeCloud_editor();
const themeCloud_editor = /* @__PURE__ */ getDefaultExportFromCjs(themeCloud_editorExports);
const themeCloud_editor$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: themeCloud_editor
}, [themeCloud_editorExports]);
export {
  themeCloud_editor$1 as t
};
